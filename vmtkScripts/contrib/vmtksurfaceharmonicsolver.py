...
class vmtkSurfaceHarmonicSolver(pypes.pypeScript):
    ...
    def __init__(self):
        ...
        self.SetInputMembers([
            ...
            ['InputRings','irings','vtkPolyData',1,'','the optional input rings, with BC values stored in InputRingsBCsArrayName; this vtkPolyData can contain more than one ring','vmtksurfacereader'],
