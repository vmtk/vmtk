...
class vmtkArrayThreshold(pypes.pypeScript):
    def __init__(self):
        pypes.pypeScript.__init__(self)

        self.SetScriptName('vmtkarraythreshold')
        self.SetScriptDoc('Extract part of surface or mesh with a point-data or cell-data array between given thresholds.')
