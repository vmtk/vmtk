    ...
    def __init__(self):
        ...
        self.SetInputMembers([
            ...
            ['Centerlines','centerlines','vtkPolyData',1,'the input centerlines','vmtksurfacereader'],
      	    ...
      	    ['CenterlineSectionMinSizeArrayName','branchsectionminsize','str',1,'name of the array where the minvmtkm diameter of each section has to be stored'],
      	    ['CenterlineSectionMaxSizeArrayName','branchsectionmaxsize','str',1,'name of the array where the maxvmtkm diameter of each bifurcation sections has to be stored'],
      	    ['CenterlineSectionShapeArrayName','centerlinesectionshape','str',1,'name of the array where the shape index, i.e. the ratio between minvmtkm and maxvmtkm diameter, of each bifurcation section has to be stored'],
        ...
        self.SetOutputMembers([
            ...
            ['Centerlines','ocenterlines','vtkPolyData',1,'the output centerlines','vmtksurfacewriter'],
      	    ...
      	    ['CenterlineSectionMinSizeArrayName','branchsectionminsize','str',1,'name of the array where the minvmtkm diameter of each section are stored'],
      	    ['CenterlineSectionMaxSizeArrayName','branchsectionmaxsize','str',1,'name of the array where the minvmtkm diameter of each bifurcation sections has to be stored'],
      	    ['CenterlineSectionShapeArrayName','centerlinesectionshape','str',1,'name of the array where the shape index, i.e. the ratio between minvmtkm and maxvmtkm diameter, of each bifurcation section are stored'],
      	    ['CenterlineSectionClosedArrayName','branchsectionclosed','str',1,'name of the array containing 1 if a section is closed and 0 otherwise']
            ])
