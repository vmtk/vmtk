...
public:
  ...
  void SetDesiredCoordinateOrientationToAxial ()
    ...
    ///     itk::SpatialOrientationEnums::ITK_COORDINATE_ORIENTATION_RPS;
  ...
  void SetDesiredCoordinateOrientationToCoronal ()
    ...
    ///      itk::SpatialOrientationEnums::ITK_COORDINATE_ORIENTATION_RIP;
    this->UseNativeCoordinateOrientation = 0;
    this->Modified();
    }
  void SetDesiredCoordinateOrientationToSagittal ()
  {
    ...
    ///      itk::SpatialOrientationEnums::ITK_COORDINATE_ORIENTATION_AIR;
    this->UseNativeCoordinateOrientation = 0;
    this->Modified();
  }
