...
=========================================================================*/
// .NAME vtkvmtkPolyDataReferenceSystemBoundaryMetricFilter - Assists in maping and patching workflow by computing boundary metrics in the boundary reference system frame.
// .SECTION Description
// ...
