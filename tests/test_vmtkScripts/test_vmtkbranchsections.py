...
@pytest.fixture(scope='module')
def branch_section_type(request, branch_sections_one_sphere, branch_sections_two_spheres):
    if request.param == "branch_sections_one_sphere":
        return branch_sections_one_sphere
    elif request.param == "branch_sections_two_spheres":
        return branch_sections_two_spheres
...
@pytest.mark.parametrize("branch_section_type,expectedValue",[
...
indirect=["branch_section_type"])
def test_branch_section_group_ids_correct(
                                          branch_section_type, expectedValue):
    wrapped_bifur_section = dsa.WrapDataObject(branch_section_type) 
...
indirect=["branch_section_type"])
def test_branch_section_area_correct(
                                     branch_section_type, expectedValue):
    wrapped_bifur_section = dsa.WrapDataObject(branch_section_type) 
...
indirect=["branch_section_type"])
def test_branch_section_min_size_correct(
                                         branch_section_type, expectedValue):
    wrapped_bifur_section = dsa.WrapDataObject(branch_section_type) 
...
indirect=["branch_section_type"])
def test_branch_section_max_size_correct(
                                         branch_section_type, expectedValue):
    wrapped_bifur_section = dsa.WrapDataObject(branch_section_type) 
...
indirect=["branch_section_type"])
def test_branch_section_shape_correct(
                                      branch_section_type, expectedValue):
    wrapped_bifur_section = dsa.WrapDataObject(branch_section_type) 
...
indirect=["branch_section_type"])
def test_branch_section_closed_correct(
                                       branch_section_type, expectedValue):
    wrapped_bifur_section = dsa.WrapDataObject(branch_section_type)
...
indirect=["branch_section_type"])
def test_branch_section_distance_to_spheres_correct(branch_section_type, expectedValue):
    wrapped_bifur_section = dsa.WrapDataObject(branch_section_type) 
