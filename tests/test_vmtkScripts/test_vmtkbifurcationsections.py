...
@pytest.fixture(scope='module')
def bifurcation_section_type(request, bifur_sections_one_sphere, bifur_sections_two_spheres):
    if request.param == "bifur_sections_one_sphere":
        return bifur_sections_one_sphere
    elif request.param == "bifur_sections_two_spheres":
        return bifur_sections_two_spheres
...
indirect=["bifurcation_section_type"])
def test_bifurcation_section_group_ids_correct(
                                               bifurcation_section_type, expectedValue):
    wrapped_bifur_section = dsa.WrapDataObject(bifurcation_section_type) 
...
indirect=["bifurcation_section_type"])
def test_bifurcation_section_bifurcation_group_ids_correct(
                                                          bifurcation_section_type, expectedValue):
    wrapped_bifur_section = dsa.WrapDataObject(bifurcation_section_type) 
...
indirect=["bifurcation_section_type"])
def test_bifurcation_section_point_correct(
                                           bifurcation_section_type , expectedValue):
    wrapped_bifur_section = dsa.WrapDataObject(bifurcation_section_type) 
...
indirect=["bifurcation_section_type"])
def test_bifurcation_section_normal_correct(
                                           bifurcation_section_type , expectedValue):
    wrapped_bifur_section = dsa.WrapDataObject(bifurcation_section_type) 
...
indirect=["bifurcation_section_type"])
def test_bifurcation_section_area_correct(
                                          bifurcation_section_type , expectedValue):
    wrapped_bifur_section = dsa.WrapDataObject(bifurcation_section_type) 
...
indirect=["bifurcation_section_type"])
def test_bifurcation_section_min_size_correct(
                                              bifurcation_section_type , expectedValue):
    wrapped_bifur_section = dsa.WrapDataObject(bifurcation_section_type) 
...
indirect=["bifurcation_section_type"])
def test_bifurcation_section_max_size_correct(
                                              bifurcation_section_type , expectedValue):
    wrapped_bifur_section = dsa.WrapDataObject(bifurcation_section_type) 
...
indirect=["bifurcation_section_type"])
def test_bifurcation_section_shape_correct(
                                           bifurcation_section_type , expectedValue):
    wrapped_bifur_section = dsa.WrapDataObject(bifurcation_section_type) 
...
indirect=["bifurcation_section_type"])
def test_bifurcation_section_closed_correct(
                                           bifurcation_section_type , expectedValue):
    wrapped_bifur_section = dsa.WrapDataObject(bifurcation_section_type) 
...
indirect=["bifurcation_section_type"])
def test_bifurcation_section_orientation_correct(
                                                 bifurcation_section_type , expectedValue):
    wrapped_bifur_section = dsa.WrapDataObject(bifurcation_section_type) 
...
indirect=["bifurcation_section_type"])
def test_bifurcation_section_distance_to_spheres_correct(
                                                 bifurcation_section_type, expectedValue):
    wrapped_bifur_section = dsa.WrapDataObject(bifurcation_section_type) 
