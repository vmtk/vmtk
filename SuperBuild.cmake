...
# find_package(Python3) sets Python3_*; backfill the legacy FindPythonInterp/
# FindPythonLibs variable names (removed in CMake 4) that the external project
# arguments below still rely on.
if (NOT PYTHON_EXECUTABLE AND Python3_EXECUTABLE)
  set( PYTHON_EXECUTABLE ${Python3_EXECUTABLE} )
endif ()
if (NOT PYTHON_INCLUDE_DIR AND Python3_INCLUDE_DIRS)
  set( PYTHON_INCLUDE_DIR ${Python3_INCLUDE_DIRS} )
endif ()
if (NOT PYTHON_LIBRARY AND Python3_LIBRARY_RELEASE)
  set( PYTHON_LIBRARY ${Python3_LIBRARY_RELEASE} )
endif ()
if (NOT PYTHON_DEBUG_LIBRARY AND Python3_LIBRARY_DEBUG)
  set( PYTHON_DEBUG_LIBRARY ${Python3_LIBRARY_DEBUG} )
endif ()
